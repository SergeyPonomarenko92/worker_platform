            ...
            <div class="flex items-center justify-between gap-4 flex-wrap">
                <div>
                    <Breadcrumbs :items="[
                        ...
                        { label: 'Історії', href: route('dashboard.stories.index', businessProfile.id) },
                        { label: story.caption || 'Редагувати', current: true },
                    ]" />
                ...
                <div class="flex gap-3">
                    <Link :href="route('dashboard.stories.index', businessProfile.id)" class="text-sm text-indigo-600 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 rounded">До історій</Link>
                </div>
            </div>
        </template>
