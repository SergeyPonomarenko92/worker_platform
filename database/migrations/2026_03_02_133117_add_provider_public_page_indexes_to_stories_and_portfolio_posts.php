...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('stories', function (Blueprint $table) {
            ...
            if ($this->indexExists('stories', $explicitIndex)) {
                return;
            }

            if ($this->indexExists('stories', $autoIndex)) {
        ...
        Schema::table('portfolio_posts', function (Blueprint $table) {
            ...
            if ($this->indexExists('portfolio_posts', $explicitIndex)) {
                return;
            }

            if ($this->indexExists('portfolio_posts', $autoIndex)) {
                $table->dropIndex($autoIndex);
            }
